 ...
 */
public class DBSwapLoading extends View {
    ...
    public DBSwapLoading(Context context) {
        this(context, null);
    }

    public DBSwapLoading(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DBSwapLoading(Context context, AttributeSet attrs, int defStyleAttr) {

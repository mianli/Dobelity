 ...
 */
public class DBCircleSun extends View {
    ...
    public DBCircleSun(Context context) {
        this(context, null);
    }

    public DBCircleSun(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DBCircleSun(Context context, AttributeSet attrs, int defStyleAttr) {

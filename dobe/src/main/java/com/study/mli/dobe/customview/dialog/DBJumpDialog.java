 ...
 */
public class DBJumpDialog extends View {
    ...
    public DBJumpDialog(Context context) {
        this(context, null);
    }

    public DBJumpDialog(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DBJumpDialog(Context context, AttributeSet attrs, int defStyleAttr) {
